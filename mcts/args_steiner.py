...
parser = argparse.ArgumentParser(description='STEINER')
...
parser.add_argument('--q-init', type=float, default=500, help='initial Q value in the mcts')
...
parser.add_argument('--graph-generator', type=str, default='GE', help='graph generator (GE or ER)')
