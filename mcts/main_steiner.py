...
from args_steiner import parser
from agent_Steiner import Agent
...
def objective():
    ...
    test_graphs = load_data("../gnn/data/random/st20/st20_test.txt", "../segnn/data/random/st20/st20_test_edges.txt", "../segnn/data/random/st20/st20_test_terminals.txt", 20, args.graph_generator)
    ...
    if args.load:
        saved_state = torch.load(
            ...
            "../gnn/saved/models/SE-GNN/0714_104627/checkpoint-epoch40.pth", # model for ER
